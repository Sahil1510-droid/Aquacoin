...
contract TokenDividendTracker is DividendPayingToken, Ownable {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 86400 && newClaimWait <= 2628288, "Token_Dividend_Tracker: claimWait must be updated to between 1 and 30 days");	
...
contract Aquacoin is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Aquacoin", "AQC") {
        ...
        marketingFee = 1;
        marketingWallet = payable(0x3c77FeF677Da3808eB788a3EeD9e1B636528ECED);
